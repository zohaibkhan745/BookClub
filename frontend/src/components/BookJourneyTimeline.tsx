...
export const BookJourneyTimeline = memo(function BookJourneyTimeline({
  ...
  return (
    <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
      ...
      {/* Timeline Container */}
      <div className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/80 dark:border-gray-800/80 rounded-2xl p-5 md:p-7 shadow-sm space-y-6">
        {/* Available on Shelf Status Banner (No icon next to text) */}
        {!isBorrowed && (
          <div className="p-4 rounded-xl border bg-emerald-50/80 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-900/40 transition-all duration-200">
        ...
        {/* Timeline of Readers (Active borrower if borrowed + Past reader stamps) */}
        {(isBorrowed || pastRecords.length > 0) && (
          <div className="relative pl-6 sm:pl-8 space-y-6 before:absolute before:top-3 before:bottom-3 before:left-3 sm:before:left-4 before:w-0.5 before:bg-gradient-to-b before:from-amber-500 before:via-gray-300 dark:before:via-gray-700 before:to-transparent">
            ...
            {isBorrowed && (
              <div className="relative">
                ...
                <div className="p-4 rounded-xl border bg-amber-50/80 dark:bg-amber-950/20 border-amber-200 dark:border-amber-900/40 transition-all duration-200">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100 text-base">
